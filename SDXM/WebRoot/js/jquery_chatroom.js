$().ready(function(){
	...
	setInterval(function(){
		...
		var $custom=$(".custom");
		 $.ajax({
             type: "POST",
             url: "/SDXM/user/getOnLineUser.do",
             async:false,
             data: null,
             dataType: "json",
		 ...
		 $(".custom").each(function(){
			...
			//获取其他人的聊天信息
		 	var id=0;
			$.post("/SDXM/message/getOthersMessage.do",null,function(data2){
			...
			//获取其他人对你的私聊信息
		 	var id2=0;
			$.post("/SDXM/message/getOtherToYouPrivilegeMessage.do",null,function(data3){
	...
	$("#sendBtn").click(function(){
		...
		if((check!=null||check!=undefined)&&$(check).attr("checked")){
			...
			$.post("/SDXM/message/savePrivilegeChatMessage.do",parameter,function(data){
			...
			$.post("/SDXM/message/saveMessage.do",parameter,function(){
