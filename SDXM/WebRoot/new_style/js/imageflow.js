...
function ImageFlow() {
    ...
    this.defaults =
        {
            ...
            slideshowSpeed: 3000,           /* 自动轮播间隔时间 */
            slideshowAutoplay: false,          /* 是否自动轮播 */
            startID: 1,              /* Image ID to begin with */
            glideToStartID: true,           /* Toggle glide animation to start ID */
            startAnimation: false,          /* Animate images moving in from the right on startup */
            xStep: 90,             /* Step width on the x-axis in px */
            rightShow:'book-detail-box li',
            showId:0
        };
    ...
    this.init = function (options) {
        ...
        //页面初始加载的时候 显示右侧第一个内容
        $('.'+my.rightShow).eq(my.showId).fadeIn(50).siblings('li').hide();
                ...
                else
                {
                    try
                    {
                        ...
                        if (newImageW && newImageH)
                        {
                            ...
                            image.style.top = newImageTop + 60 + 'px';
                        }
                        ...
                        switch (image.i == my.imageID)
                        {
                            case false:
                                image.onclick = function () {
                                    my.glideTo(this.i);
                                    my.showId = $('#starsIF_images img').eq(this.i).attr('showId');
                                    $('.'+my.rightShow).eq(my.showId).show().siblings('li').hide();
                                };
                                break;
//
                            default:
    ...
    this.glideTo = function (imageID)
    {
        ...
        if (my.circular)
        {
            ...
            if (imageID === (my.max - my.imageFocusMax + 1))
            {
                /* Set jump target to the same cloned image on the left */
                clonedImageID = my.imageFocusMax - 1;
                jumpTarget = -clonedImageID * my.xStep;
