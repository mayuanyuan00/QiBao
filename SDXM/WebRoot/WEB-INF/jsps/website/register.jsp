...
<div class="dataEye">
	<div class="loginbox registbox">
		<div class="login-content reg-content">
			...
			<div class="row">
				<!-- <label class="field" for="passwordAgain">手机号</label> -->
				<input type="text" placeholder="手机号" value="" class="input-text-password noPic input-click" name="phone" id="phone">
			</div>
			<div class="row">
				<!-- <label class="field" for="passwordAgain">邮箱</label> -->
				<input type="text" placeholder="邮箱" value="" class="input-text-password noPic input-click" name="email" id="email">
			</div>
			<div class="row">
