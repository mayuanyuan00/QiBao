...
<div class="header" id="header">
    <div class="header-box"><!--已登录状态加login 隐藏登陆注册按钮 显示登录人员名字-->
        <img class="logo" src="${pageContext.request.contextPath}/new_style/img/public/logo.png" />

        <div class="user-opera-box">
            <a class="shopping-car" href="${pageContext.request.contextPath}/cart/shoppingcart.do" onclick="return checkLogin()">购物车</a>
            <c:if test="${empty sessionScope.user}">
            <span class="user-opera signbtn">注册</span>
            <span class="user-opera loginbtn">登录</span>
            </c:if>
            ...
            <div class="search_box">
                <form method="get" action=""
                    ...
                    <input id="search_button" name="" type="button"  class="search_btn" onclick="checkNull();">
                </form>
            </div>
        </div><!--user-opera-box-->
        <c:if test="${not empty sessionScope.user}">
        <div class="user-welcome">
            欢迎你，<a href="${pageContext.request.contextPath}/home/personalInformation.do">${sessionScope.user.userName}</a><span><a class="link-article" href="javascript:void(0)" onclick="loginOut()">【退出】</a></span>
        </div>
        </c:if>
    </div><!--header-box-->
    <div class="nav-outter">
        <div class="nav-list">
            <ul>
                <li><a href="${pageContext.request.contextPath}/home/homeIndex.do" id="1">首页</a></li>
                <li><a href="${pageContext.request.contextPath}/home/newsList.do" id="2">新闻公告</a></li>
                <li><a href="${pageContext.request.contextPath}/home/bookTypeList.do" id="3">图书专区</a></li>
                <li><a href="${pageContext.request.contextPath}/waiter.jsp" id="4">数字出版</a></li>
                <li><a href="${pageContext.request.contextPath}/home/contact.do" id="5">互动专区</a></li>
                <li><a href="${pageContext.request.contextPath}/home/pressCulture.do" id="6">关于我社</a></li>
            </ul>
        </div>
</div>
