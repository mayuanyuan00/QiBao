                ...
                <c:choose>
                    <c:when test="${par ne '关于我们'}">
                        <div class="about-back">
                            <a href="${pageContext.request.contextPath}/home/contact.do?page=${page}&lastType=${news.type}">返回上一页</a>
                        </div>
                    </c:when>
                    <c:otherwise>
                        <div class="about-back">
                            <a href="${pageContext.request.contextPath}/home/pressCulture.do?type=${news.type}">返回上一页</a>
                        </div>
                    </c:otherwise>
                </c:choose>
            </div>
