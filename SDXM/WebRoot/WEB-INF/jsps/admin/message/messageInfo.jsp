        ...
        <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                    ...
                    <td align="left" id="email" valign="middle" class="borderright borderbottom main-for">${message.userName}</td>
                </tr>
                <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                    onMouseOver="this.style.backgroundColor='#edf5ff'">
                    <td align="right" valign="middle" class="borderright borderbottom bggray">留言时间：</td>
                    <td align="left" id="time" valign="middle" class="borderright borderbottom main-for">${message.createTime}</td>
                </tr>
                <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                    onMouseOver="this.style.backgroundColor='#edf5ff'">
                    <td align="right" valign="middle" class="borderright borderbottom bggray">留言标题：</td>
                    <td align="left" id="title" valign="middle" class="borderright borderbottom main-for">${message.title}</td>
                </tr>
                <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                    onMouseOver="this.style.backgroundColor='#edf5ff'">
                ...
                <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                    onMouseOver="this.style.backgroundColor='#edf5ff'">
                    <td align="right" valign="middle" class="borderright borderbottom bggray _all">操作：</td>
                    <td align="left" valign="middle" class="borderright borderbottom main-for">
                        <a href="<c:url value='/message/messageReplay.do?id=${message.id}'/>"
                           target="mainFrame" onFocus="this.blur()" class="add _edit">回复</a>
                        <span class="gray">&nbsp;<span class="_divide_1">|</span>&nbsp;</span>
                        <a href="/message/changeShow.do?id=${message.id}"  target="mainFrame" onFocus="this.blur()"
                           class="add _release">
